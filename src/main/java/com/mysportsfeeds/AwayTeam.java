...
/**
 * This class holds the away team values for the mysportsfeeds api
 *
...
public class AwayTeam{
     ...
     *
     * @param abbreviation the value to set the local abbrebiation variable
     */
     ...
     *
     * @return the local abbreviation variable
     */
